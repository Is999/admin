...
INSERT INTO `admin_permission` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `description`, `status`, `created_at`, `updated_at`) VALUES (34, '100034', 'MFA状态', 'user.admin_mfa_status', 23, '1,23', 2, '修改管理员MFA状态(修改)', 1, '2026-05-01 00:00:00', '2026-05-01 00:00:00');
...
INSERT INTO `admin_permission` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `description`, `status`, `created_at`, `updated_at`) VALUES (51, '100051', '生成MFA绑定地址', 'user.build_mfa_url', 26, '1,23,26', 0, '生成管理员MFA绑定地址(查看)', 1, '2026-05-01 00:00:00', '2026-05-01 00:00:00');
...
INSERT INTO `admin_permission` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `description`, `status`, `created_at`, `updated_at`) VALUES (71, '200001', 'Cron任务中心', '4', 0, '', 4, 'Cron任务中心(目录)', 1, '2026-05-01 00:00:00', '2026-05-01 00:00:00');
