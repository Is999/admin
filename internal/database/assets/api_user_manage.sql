...
-- 范围：仅补后台权限、超管权限关联和 MFA 场景示例；不创建或修改 API 用户业务表。

INSERT INTO `admin_permission` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `description`, `status`, `created_at`, `updated_at`) VALUES
(146, '100092', '前台用户', 'api_user.list', 1, '1', 5, '前台用户管理(菜单,页面)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(147, '100093', '查询', 'api_user.info', 146, '1,146', 0, '查询前台用户详情(查看)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(148, '100094', '新增', 'api_user.add', 146, '1,146', 1, '新增前台用户(新增)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(149, '100095', '编辑', 'api_user.update', 146, '1,146', 2, '编辑前台用户资料(修改)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(150, '100096', '启用/禁用', 'api_user.status.update', 146, '1,146', 2, '启用或禁用前台用户(修改)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(151, '100097', '重置密码', 'api_user.password.reset', 146, '1,146', 2, '重置前台用户密码(修改)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(152, '100098', '同步运行态', 'api_user.runtime.sync', 146, '1,146', 2, '同步前台用户API运行态(修改)', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
