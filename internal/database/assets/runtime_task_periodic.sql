...
INSERT IGNORE INTO `runtime_task_periodic` (
  `id`, `app_id`, `env`, `name`, `enabled`, `cron`, `every_seconds`, `workflow`, `queue`,
  `targets_json`, `shard_total`, `gray_percent`, `retry`, `timeout_seconds`, `deadline`,
  `unique_key`, `unique_ttl_seconds`, `sort_order`, `remark`, `created_by_admin_id`,
  `updated_by_admin_id`, `created_at`, `updated_at`
) VALUES
(1, '1', 'dev', 'archive-admin-log-hourly', 1, '5 * * * *', 0, 'archive.run', 'maintenance', '["admin_log"]', 2, 0, 2, 7200, '', 'periodic:archive.run:admin_log', 3300, 1, '', 0, 0, '2026-06-16 00:00:00', '2026-06-16 00:00:00'),
(2, '1', 'dev', 'user-tag-delta-daily', 0, '15 3 * * *', 0, 'user_tag.delta.refresh', 'maintenance', NULL, 1, 0, 2, 0, '', 'periodic:user_tag.delta.refresh', 82800, 2, '', 0, 0, '2026-06-16 00:00:00', '2026-06-16 00:00:00'),
(3, '1', 'dev', 'user-tag-runtime-cleanup', 0, '25 */6 * * *', 0, 'user_tag.runtime.cleanup', 'maintenance', NULL, 0, 0, 2, 3600, '', 'periodic:user_tag.runtime.cleanup', 7200, 3, '', 0, 0, '2026-06-16 00:00:00', '2026-06-16 00:00:00'),
(4, '1', 'dev', 'user-tag-event-outbox-retry-scan', 0, '*/10 * * * *', 0, 'user_tag.event_outbox.retry_scan', 'maintenance', NULL, 0, 0, 1, 540, '', 'periodic:user_tag.event_outbox.retry_scan', 540, 4, '', 0, 0, '2026-06-16 00:00:00', '2026-06-16 00:00:00');
