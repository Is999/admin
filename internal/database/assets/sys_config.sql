...
INSERT IGNORE INTO `sys_config` (`id`, `uuid`, `title`, `type`, `value`, `example`, `remark`, `page`, `pid`, `pids`, `version`, `created_at`, `updated_at`) VALUES (2, 'adminIpWhitelistEnabled', 'Admin启用IP白名单', 6, '0', '1', '后台IP白名单开关：1启用；0禁用。启用后白名单为空时拒绝全部登录。', '', 1, '1', 0, '2025-11-26 10:49:01', '2026-07-16 00:00:00');
