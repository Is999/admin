...
INSERT IGNORE INTO `sys_config` (`id`, `uuid`, `title`, `type`, `value`, `example`, `remark`, `page`, `pid`, `pids`, `version`, `created_at`, `updated_at`) VALUES (3, 'adminIpWhitelist', 'AdminIP白名单', 2, '[]', '[\"8.8.8.8\", \"127.0.0.1\"]', 'IP白名单: 多个IP以英文逗号分割', '', 1, '1', 0, '2025-11-26 10:58:40', '2026-05-06 15:42:51');
