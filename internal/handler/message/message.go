...
func ListAdminMessageHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageQueryReq](shared.MethodListAdminMessage, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageQueryReq) (shared.LogicObj, *types.BizResult) {
...
func MarkAdminMessageReadHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageMarkReadReq](shared.MethodMarkAdminMessageRead, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageMarkReadReq) (shared.LogicObj, *types.BizResult) {
		logicObj := messagelogic.NewAdminMessageLogic(r, svcCtx)
...
func DeleteAdminMessageHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageDeleteReq](shared.MethodDeleteAdminMessage, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageDeleteReq) (shared.LogicObj, *types.BizResult) {
		logicObj := messagelogic.NewAdminMessageLogic(r, svcCtx)
...
func SendAdminMessageHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageSendReq](shared.MethodSendAdminMessage, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageSendReq) (shared.LogicObj, *types.BizResult) {
		logicObj := messagelogic.NewAdminMessageLogic(r, svcCtx)
...
func ListAdminMessageSentHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageSentQueryReq](shared.MethodListAdminMessageSent, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageSentQueryReq) (shared.LogicObj, *types.BizResult) {
		logicObj := messagelogic.NewAdminMessageLogic(r, svcCtx)
...
func ListAdminMessageReceiversHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageIDPathReq](shared.MethodListAdminMessageReceivers, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageIDPathReq) (shared.LogicObj, *types.BizResult) {
		logicObj := messagelogic.NewAdminMessageLogic(r, svcCtx)
...
func HandleAdminMessageHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.AdminMessageHandleReq](shared.MethodHandleAdminMessage, func(r *http.Request, svcCtx *svc.ServiceContext, req *types.AdminMessageHandleReq) (shared.LogicObj, *types.BizResult) {
		logicObj := messagelogic.NewAdminMessageLogic(r, svcCtx)
