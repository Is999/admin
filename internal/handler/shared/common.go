...
const (
	...
	runtimeConfigOverview        method = "runtimeConfigOverview"        // 查询运行配置概览
	runtimeConfigList            method = "runtimeConfigList"            // 查询运行配置
	runtimeConfigSave            method = "runtimeConfigSave"            // 保存运行配置草稿
	runtimeConfigValidate        method = "runtimeConfigValidate"        // 预检运行配置
	runtimeConfigPublish         method = "runtimeConfigPublish"         // 发布运行配置
	runtimeConfigRollback        method = "runtimeConfigRollback"        // 回滚运行配置
	runtimeConfigImport          method = "runtimeConfigImport"          // 导入运行配置
...
const (
	...
	MethodRuntimeConfigOverview        Method = runtimeConfigOverview        // 查询运行配置概览
	MethodRuntimeConfigList            Method = runtimeConfigList            // 查询运行配置
	MethodRuntimeConfigSave            Method = runtimeConfigSave            // 保存运行配置草稿
	MethodRuntimeConfigValidate        Method = runtimeConfigValidate        // 预检运行配置
	MethodRuntimeConfigPublish         Method = runtimeConfigPublish         // 发布运行配置
	MethodRuntimeConfigRollback        Method = runtimeConfigRollback        // 回滚运行配置
	MethodRuntimeConfigImport          Method = runtimeConfigImport          // 导入运行配置
...
var actionLogRegistry = map[method]RouteMeta{
	...
	runtimeConfigOverview:        RuntimeConfigOverview,        // 查询运行配置概览
	runtimeConfigList:            RuntimeConfigList,            // 查询运行配置
	runtimeConfigSave:            RuntimeConfigSave,            // 保存运行配置草稿
	runtimeConfigValidate:        RuntimeConfigValidate,        // 预检运行配置
	runtimeConfigPublish:         RuntimeConfigPublish,         // 发布运行配置
	runtimeConfigRollback:        RuntimeConfigRollback,        // 回滚运行配置
	runtimeConfigImport:          RuntimeConfigImport,          // 导入运行配置
