...
func TriggerUserTagWorkflowHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.TriggerUserTagWorkflowReq](shared.MethodTriggerUserTagWorkflow,
...
func RecalculateUserTagHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.RecalculateUserTagReq](shared.MethodRecalculateUserTag,
...
func ReleaseUserTagWorkflowLeaseHandler(sCtx *svc.ServiceContext) http.HandlerFunc {
	return shared.ActionHandler[types.ReleaseUserTagWorkflowLeaseReq](shared.MethodReleaseUserTagWorkflowLease,
