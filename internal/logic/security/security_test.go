...
func TestPermissionSQLContainsRequiredCurrentModules(t *testing.T) {
	...
	requiredModules := []string{
		...
		"task.items.list",
		"user_tag.index",
		string(routealias.APIUserList),
		string(routealias.APIUserAdd),
		string(routealias.APIUserUpdate),
		string(routealias.APIUserStatusUpdate),
		string(routealias.APIUserPasswordReset),
		string(routealias.APIUserRuntimeSync),
		...
		string(routealias.DocsAPIUserTag),
