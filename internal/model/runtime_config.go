...
type RuntimeTaskPeriodic struct {
	ID               uint64      `gorm:"column:id;type:bigint unsigned;primaryKey;autoIncrement:true;comment:主键ID" json:"id"`                                            // 主键 ID
	Name             string      `gorm:"column:name;type:varchar(128);not null;uniqueIndex:uk_name;comment:周期任务名称" json:"name"`                                          // 周期任务名称
	Enabled          bool        `gorm:"column:enabled;type:tinyint(1);not null;default:1;index:idx_workflow_enabled_sort,priority:2;comment:是否启用" json:"enabled"`       // 是否启用
	...
	Workflow         string      `gorm:"column:workflow;type:varchar(128);not null;default:'';index:idx_workflow_enabled_sort,priority:1;comment:工作流名称" json:"workflow"` // 工作流名称
	...
	SortOrder        int         `gorm:"column:sort_order;type:int;not null;default:0;index:idx_workflow_enabled_sort,priority:3;comment:排序值" json:"sortOrder"`          // 排序值
...
type RuntimeArchiveJob struct {
	ID                      uint64    `gorm:"column:id;type:bigint unsigned;primaryKey;autoIncrement:true;comment:主键ID" json:"id"`                                            // 主键 ID
	Name                    string    `gorm:"column:name;type:varchar(128);not null;uniqueIndex:uk_name;comment:归档任务名称" json:"name"`                                          // 归档任务名称
	Enabled                 bool      `gorm:"column:enabled;type:tinyint(1);not null;default:1;comment:是否启用" json:"enabled"`                                                  // 是否启用
	Database                string    `gorm:"column:database_name;type:varchar(64);not null;default:'main';index:idx_archive_table,priority:1;comment:热表数据库" json:"database"` // 热表数据库
	HotTableName            string    `gorm:"column:table_name;type:varchar(128);not null;default:'';index:idx_archive_table,priority:2;comment:热表名" json:"tableName"`        // 热表名
