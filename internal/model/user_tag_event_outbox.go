...
type UserTagEventOutbox struct {
	...
	UID          int64                   `gorm:"column:uid;type:bigint;not null;index:idx_uid_tag_action,priority:1;comment:用户ID" json:"uid"`                                                                                                  // 用户 ID
	...
	ShardNo      int8                    `gorm:"column:shard_no;type:tinyint;not null;default:0;index:idx_workflow_state_shard_id,priority:3;comment:uid取模分片" json:"shard_no"`                                                                 // UID 分片号
