...
type UserTagRecord struct {
	...
	ShardNo     int       `gorm:"column:shard_no;type:int;not null;default:0;index:idx_shard_uid,priority:1;index:idx_tag_type_shard_uid,priority:2;comment:取模分片" json:"shard_no"`                                 // 取模分片
