...
// writeTaskRuntimeAttemptScriptText 保存任务 attempt 运行快照回写 Lua 脚本源码。
// 只有 hash 中 attemptToken 仍匹配时才会清理指定字段、写入快照并续期。
//
...
//
//go:embed assets/write_workflow_task_stats_attempt.lua
var writeWorkflowTaskStatsAttemptScriptText string
